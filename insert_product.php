...
if(isset($_POST['submit'])){
    ...
    $insert_product = "insert into product(pCAT_ID,cAT_ID,date,product_Title,product_img1,product_img2,product_img3,product_price,product_keyword,product_description) values ('$product_cat','$cat',NOW(),'$product_title','$product_img1','$product_img2','$product_img3','$product_price','$product_keywords','$product_desc')";
